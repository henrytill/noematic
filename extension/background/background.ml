...
let handle_message message = Console.log [ Jstr.v "Received message: "; message ]

let listener connected port =
  connected := port :: !connected;
  Port.Event.add_listener (Port.on_message port) handle_message;
...
let () =
  ...
  Event.add_listener on_connect (listener connected_ports)
